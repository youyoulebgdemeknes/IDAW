<body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#index.php">Acceuil</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="info_tech">Information Technique</a></li>
